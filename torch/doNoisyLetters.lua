...
--nstates = {60, 160, 1200} -- x 10 --- physiological parameters --- 
    ...
    local channels_svhn_imageSize_train = {32, 32}
    --local channels_svhn_imageSize_train = {64, 64}
    ...
    --local channels_imageSize = {32, 32}
        local channels_SVHN_settings_noNorm = {imageSize = channels_svhn_imageSize_train, globalNorm = true, localContrastNorm = false}
        local channels_SVHN_settings_norm   = {imageSize = channels_svhn_imageSize_train, globalNorm = true, localContrastNorm = true}
        
        --local channels_SVHN_settings_noNorm_32 = {imageSize = {32, 32}, globalNorm = true, localContrastNorm = false}
        --local channels_SVHN_settings_norm_32 = {imageSize = {32, 32}, globalNorm = true, localContrastNorm = true}
    ...
    local grouping_imageSize_test = {32, 32}
    local grouping_trainOn = 'SVHN'
        local grouping_SVHN_settings = {imageSize = {32, 32}, globalNorm = true, localContrastNorm = false}
    ...
    ------- Complexity Settings ------
    local complexity_svhn_imageSize_train = {32, 32}
    --local complexity_svhn_imageSize_train = {64, 64}
    ...
    local complexity_trainOn = 'SVHN'
    --local complexity_trainOn = 'WhiteNoise'
        
    
        local complexity_SVHN_settings_noNorm = {imageSize = complexity_svhn_imageSize_train, globalNorm = true, localContrastNorm = false}
        local complexity_SVHN_settings_norm   = {imageSize = complexity_svhn_imageSize_train, globalNorm = true, localContrastNorm = true}
...
--        allNHiddenUnits = {4,10,20,40,100,200}
  ...
  --          {6, 15}, {6, 30}, {6,60}, {6,120}, {6, 240}, {12, 15}, {12, 30}, {12,60}, {12,120}, {12, 240} }
    ...
    local allOriXY_5x5y11o = {Nori = 11, dOri = 4,    Nx = 5, dX = 4,    Ny = 5, dY = 4}
    local allOriXY_5x5y11o_d2 = {Nori = 11, dOri = 2,    Nx = 5, dX = 2,    Ny = 5, dY = 2}
    local allOriXY_41o = {Nori = 41, dOri = 1,    Nx = 1, dX = 0,    Ny = 1, dY = 0}
    local allOriXY_7x7y = {Nori = 1, dOri = 0,    Nx = 7, dX = 2,    Ny = 7, dY = 2}
    ...
    local allOriXY_2x2y3o  = {Nori = 3,  dOri = 5,    Nx = 2, dX = 5,   Ny = 2, dY = 5}
    local allOriXY_3x6y7o  = {Nori = 7,  dOri = 5,    Nx = 3, dX = 4,   Ny = 6, dY = 4}
    local allOriXY_3x6y7o_d2  = {Nori = 7,  dOri = 5,    Nx = 3, dX = 2,   Ny = 6, dY = 2}
        
        local allOriXY_2x_d4   = {Nori = 1,  dOri = 0,    Nx = 2, dX = 4,   Ny = 1, dY = 0}        
        local allOriXY_2x2y_d4 = {Nori = 1,  dOri = 0,    Nx = 2, dX = 4,   Ny = 2, dY = 4}        
        local allOriXY_2x4y_d4 = {Nori = 1,  dOri = 0,    Nx = 2, dX = 4,   Ny = 4, dY = 4}        
        
        local allOriXY_3o_d5 = {Nori = 3,  dOri = 5,    Nx = 1, dX = 0,   Ny = 1, dY = 0}        
        local allOriXY_7o_d5 = {Nori = 7,  dOri = 5,    Nx = 1, dX = 0,   Ny = 1, dY = 0}        
        local allOriXY_11o_d4 = {Nori = 11,  dOri = 4,    Nx = 1, dX = 0,   Ny = 1, dY = 0}        
        local allOriXY_21o_d2 = {Nori = 21,  dOri = 2,    Nx = 1, dX = 0,   Ny = 1, dY = 0}        
    
        local allOriXY_13o_d5 = {Nori = 13,  dOri = 5,    Nx = 1, dX = 0,   Ny = 1, dY = 0}        
        local allOriXY_19o_d5 = {Nori = 19,  dOri = 5,    Nx = 1, dX = 0,   Ny = 1, dY = 0}        
        local allOriXY_25o_d5 = {Nori = 25,  dOri = 5,    Nx = 1, dX = 0,   Ny = 1, dY = 0}        
        local allOriXY_37o_d5 = {Nori = 37,  dOri = 5,    Nx = 1, dX = 0,   Ny = 1, dY = 0}        
    ...
    local xrange, trainTargetPosition, testTargetPosition
    local allMultiLetterTestOpts_tbl
    
    local tbl_trainingImageSize, tbl_SVHN_fontNames
    local loopKeysOrder_letterOpts 
    ...
    if expName == 'ChannelTuning' then
        ...
        if channels_doSVHN then
            ...
            tbl_SVHN_fontNames = { {fonts = 'SVHN', svhn_opts = channels_SVHN_settings_norm}, 
                                   {fonts = 'SVHN', svhn_opts = channels_SVHN_settings_noNorm}, 
                                    }
        end
        ...
        --tbl_OriXY = { allOriXY_one } --  allOriXY_6x5y21o, 
        tbl_OriXY = { allOriXY_2x2y3o, allOriXY_4x4y7o, allOriXY_one } --  allOriXY_6x5y21o, 
        ...
        if channelTuningStage == 'train' then
            ...
            if channels_doSVHN then
                --tbl_fontNames = { {'SVHN'}  }              --TRAIN ON SVHN
                tbl_fontNames = tbl_SVHN_fontNames
                 allSNRs_test = {0}
        ...
        elseif channelTuningStage == 'test' then
            ...
            if channels_doSVHN then 
                tbl_trainingFonts = tbl_SVHN_fontNames
                --tbl_trainingImageSize = { channels_svhn_imageSize_train } -- this is done automatically
            ...
            loopKeysOrder_letterOpts  = {'noiseFilter', 'trainingNoise', 'OriXY', 'trainingFonts', 'fontName', 'retrainFromLayer',};
        end 
    ...
    elseif expName == 'Complexity' then
        ...
        if complexity_trainOn == 'SVHN' then
            --tbl_fontNames = { {'SVHN'}  }              --TRAIN ON SVHN
            tbl_SVHN_fontNames = { {fonts = 'SVHN', svhn_opts = complexity_SVHN_settings_noNorm}, 
                                   {fonts = 'SVHN', svhn_opts = complexity_SVHN_settings_norm},
                                   }
            ...
            elseif complexityStage == 'test' then
                ...
                loopKeysOrder_letterOpts  = {'retrainFromLayer',  'trainingFonts', 'fontName'};
            end
        ...
        elseif complexity_trainOn == 'PinkNoise' then
            ...
            elseif complexityStage == 'test' then
                ...
                loopKeysOrder_letterOpts  = {'fontName', 'trainingNoise', 'OriXY', 'retrainFromLayer'};
            end
        ...
        if complexity_imageSize[1] == 80 then
            ...
            tbl_OriXY = { allOriXY_2x2y3o, allOriXY_3x6y7o, allOriXY_one } --  allOriXY_6x5y21o, 
        elseif complexity_imageSize[1] == 64 then
            ...
            tbl_OriXY = { allOriXY_one, allOriXY_3o_d5, allOriXY_7o_d5, allOriXY_11o_d4, allOriXY_21o_d2, 
                        allOriXY_13o_d5, allOriXY_19o_d5, allOriXY_25o_d5, allOriXY_37o_d5} --  allOriXY_6x5y21o, 

        elseif complexity_imageSize[1] == 56 then
            --tbl_imageSize_and_sizeStyle =  {  {{64, 64}, 'k32'} }
            tbl_imageSize_and_sizeStyle =  {  {{56, 56}, 'k15'} }
            tbl_OriXY = { allOriXY_2x2y3o, allOriXY_3x6y7o_d2, allOriXY_3x6y7o, allOriXY_one } --  allOriXY_6x5y21o, 
            
            tbl_OriXY = { allOriXY_2x_d4, allOriXY_2x2y_d4, allOriXY_2x4y_d4, }
              --  allOriXY_3o_d5, allOriXY_7o_d5, allOriXY_11o_d4, allOriXY_21o_d2, allOriXY_one} --  allOriXY_6x5y21o, 
                        
            tbl_OriXY = { allOriXY_13o_d5, allOriXY_19o_d5, allOriXY_25o_d5, allOriXY_37o_d5, allOriXY_one} --  allOriXY_6x5y21o, 
            
            tbl_OriXY = { allOriXY_one, allOriXY_2x_d4, allOriXY_2x2y_d4, allOriXY_2x4y_d4, allOriXY_3x6y7o, allOriXY_3x6y7o_d2, }
        ...
        if (complexity_trainOn == 'SVHN' and complexityStage == 'train') then
            tbl_OriXY = { allOriXY_one }
        end        
    ...
    elseif expName == 'Grouping' then
        ...
        if groupingStage == 'train' then
            ...
            if grouping_trainOn == 'SVHN' then
                ...
                tbl_imageSize = { grouping_SVHN_settings.imageSize }
                tbl_OriXY         = { allOriXY_one }  
        ...
        elseif groupingStage == 'test' then
            ...
            if grouping_trainOn == 'SVHN' then
                ...
                --tbl_trainingImageSize = { grouping_SVHN_settings.imageSize } -- this is done automatically
                --tbl_OriXY         = { allOriXY_one, allOriXY_5x5y11o, allOriXY_10x10y21o } 
                tbl_OriXY         = { allOriXY_5x5y11o_d2, allOriXY_41o, allOriXY_7x7y, allOriXY_one, allOriXY_5x5y11o,  }
            ...
            loopKeysOrder_letterOpts  = {'trainingNoise', 'OriXY', 'fontName', 'retrainFromLayer'};
    ...
    elseif expName == 'Crowding' then
        ...
        allSNRs_test = table.range(0, 6,  0.5);
        
        if doConvNet or doTextureModel then
            tbl_imageSize = {{32, 160}}
            xrange = {-16, 12, 176};
            trainTargetPosition = table.range(3,15);
            testTargetPosition = 9 -- CONVNET & TEXTURE STATISTICS
        elseif doOverFeat then
            tbl_imageSize = {{231, 231}};  
            xrange = {-34,15,266}; 
            trainTargetPosition = table.range(4,18);  
            testTargetPosition = 11   --- OVERFEAT
        end
            
        allMultiLetterTestOpts_tbl = {  testTargetPosition = testTargetPosition,
    ...
    local allNoisyLetterOpts_tbl = { expName = expName, 
                                      stimType = stimType,
                                      ...
                                      ---- Crowding options      
                                      xrange = xrange,
                                      trainTargetPosition = trainTargetPosition,
                                      allMultiLetterTestOpts_tbl = allMultiLetterTestOpts_tbl,
                                    }
    
    taskOpts = {loopKeysOrder_letterOpts = loopKeysOrder_letterOpts}
    ...
    if saveTaskFile then
        ...
        io.write('Creating task file : Enter description of current task ')
        ...
        if not (descrip == '') then
            ...
            taskOpts.taskFileName=taskFileNameBase
            taskOpts.descrip = descrip
                          
            local taskData = {allNetworkOptions_tbl = allNetworkOptions_tbl, 
                              allNoisyLetterOpts_tbl = allNoisyLetterOpts_tbl, 
                              opts = taskOpts}
  
           
            torch.save(taskFileName, taskData);
    ...
    results = doNoisyLettersTask(allNetworkOptions_tbl, allNoisyLetterOpts_tbl, taskOpts)
