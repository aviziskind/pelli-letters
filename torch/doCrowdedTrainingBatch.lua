    ...
    for trial_i = 1,nTrials do
        ...
        for opt_i, crowdedLetterOpts in ipairs(all_LetterOpts) do        
            ...
            for net_i, networkOpts_i in ipairs(allNetworks) do
                ...
                local resultsFileExists, results_filename = fileExistsInSisterSubdirs(results_dir_main, preferred_results_subdir, results_filename_base)
                ...
                if doMultiLetters then
                    for i,optMultiLet in ipairs(allMultiLetOpt) do
                        ...
                        local resultsFileExists_2let, results_filename_2let = fileExistsInSisterSubdirs(results_dir_main, preferred_results_subdir, results_filename_base_2let)
                ...
                if (resultsFileExists and not resultsFileTooOld and not redoResultsFiles)
                    ...
                    if not gotLock then 
                        ...
                        trainOpts.trainingFileBase = training_dir .. expSubtitle
